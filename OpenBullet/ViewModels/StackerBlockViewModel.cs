    ...
    public class StackerBlockViewModel : ViewModelBase
    {
        ...
        public StackerBlockViewModel(BlockBase block, Random rand)
        {
            ...
            var ts = new TypeSwitch()
                ...
                .Case((BlockOCR x) => Page = new PageBlockOCR(x))
                .Case((BlockBlockchainDNS x) => Page = new PageBlockBlockchainDNS(x))
        ...
        public Color GetBlockColor()
        {
            ...
            var ts = new TypeSwitch()
                ...
                .Case((BlockOCR x) => color = Colors.Azure)
                .Case((BlockBlockchainDNS x) => color = Colors.DarkSlateBlue)
